...
/**
 * A text object using a spritesheet.
 * Currently unused, as we are using an actual font instead, but you can use it if you want.
 */
...
private class AtlasFontData
{
	...
	{
		atlas = Paths.getSpritesheet("fonts/" + name.getName().toLowerCase());
