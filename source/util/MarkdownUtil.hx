...
class MarkdownUtil
{
	...
	static function createAdvancedMarkerPair(marker:String, ?fontColor:FlxColor, ?bold:Bool, ?italic:Bool, ?borderColor:FlxColor, ?size:Int, ?underline:Bool, ?blockIndent:Int,
			?bullet:Bool)
	{
